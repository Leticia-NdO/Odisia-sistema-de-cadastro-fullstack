        ...
        <>
            <div className='textfield'>
                ...
                <select name="pais" id="pais" defaultValue={
                    ...
                    <option value="default">Selecione o seu país de origem</option>
            ...
            <div className='textfield'>
                ...
                <select name="estado" defaultValue={formData.estado} onChange={(event) => setFormData({ ...formData, estado: event.target.value })}>
                    <option value="default">Selecione o estado onde mora</option>
            ...
            <div className='textfield'>
                ...
                <input type="text" name='pais' placeholder='Insira o município onde vive' defaultValue={formData.municipio} onChange={(event) => setFormData({ ...formData, municipio: event.target.value })} />
            </div>
        </>
    )
}
